...
$sql = "select * from vw_show_product where id_products < 55";
...
<body style="font-family: 'Hind', sans-serif;">
  ...
  <div class="s01">
    <div class="left">
      ...
      <div class="head1"></div>
      <?php
      $sql = "select  * from vw_show_product where id_products = 85  ;";
    ...
    <div class="b02">
      <div class="tyles" style=" ">
        <div class="tyle" style="">
          <h5 class="texts">Some other featured products</h5>
        </div>
        <div class="hinh_binh_hanh"></div>
      </div>
      <div class="head1"></div>
